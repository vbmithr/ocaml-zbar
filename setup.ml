...
(* OASIS_START *)
(* DO NOT EDIT (digest: eb667aa67710802ddc4746471b2ecb30) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("zbar-api", OCamlbuildDocPlugin.doc_build "./lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("zbar-api", OCamlbuildDocPlugin.doc_clean "./lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\t=8`<\165\251\0256\219\210t\241'\182|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
