...
(* OASIS_START *)
(* DO NOT EDIT (digest: 29686a5df580b2ecc2ee6962de32b5bd) *)
(*
...
let setup_t =
  {
       ...
       [
          ("zbar",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "./classic"})
       ];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build the ctypes binding";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build the classic OCaml FFI binding";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["zbar_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lzbar"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "zbar"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Zbar";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\155\240\nEJ\185\020\148\193\2050t\222\145Z\143";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
